...
# SRC_REN = 	main.c test_pars.c aa.c j.c reycasting/drawing.c reycasting/key_event.c \
# 			reycasting/raycasting.c

# SRC_PAR_PRE = $(addprefix parse/, $(SRC_PAR))

# SRC_REN_PRE = $(addprefix rendring/, $(SRC_REN))
...
# clean :
# 	@rm -fr $(OBJ_PAR) $(OBJ_REN)

# fclean : clean
# 	@rm -fr $(OBJ_PAR) $(OBJ_REN) $(NAME)
