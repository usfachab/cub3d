...
// void cast_ray(t_data *data, t_player *player, double angle, int rayNum);
...
void draw_wall_slice(t_data *data, int x, double height);
...
//     {
//         my_mlx_pixel_put(data, x, y, 0xFFFFFF); // color of wall
//     }
// }
